...
int rt5659_sel_asrc_clk_src(struct snd_soc_component *component,
...
void rt5659_jack_suspend(struct snd_soc_component *component);
void rt5659_jack_resume(struct snd_soc_component *component);
